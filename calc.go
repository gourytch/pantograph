...
type Position struct {
	X, Y float64 // координата привязки двигающего рычага в пространстве
}
type Engine struct {
	Position  // положение в пространстве
	R float64 // длина рычага
	A float64 // нейтральный CCW-поворот рычага от абциссы в радианах
}
